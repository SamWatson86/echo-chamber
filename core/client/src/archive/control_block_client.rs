//! Client-side copy of control block structures.
//! Must stay in sync with core/hook/src/control_block.rs.
...
pub struct CaptureControlBlock {
    ...
    pub format: u32,
    /// Set by client. Present vtable address resolved in client process.
